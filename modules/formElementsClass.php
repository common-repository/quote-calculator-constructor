		...
		function generate_result_block(){
			...
			switch( $this->type ){
				...
				case "mediafile_single":
					...
					<div class="col-12 bulma">
						<div class="control_block field">
							<a href="#" class="button is-danger" id="add_row" >Add Row</a>
						</div>
				
						<div id="layout_editor" class="field sortable"></div>
					...
					<br/>
					<input type="hidden"  value="'. htmlentities( $this->value ) .'" id="interface_data" name="interface_data" />
					';	
