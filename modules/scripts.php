...
$scripts_list = array(
	'common' => array(
		...
		array( 'type' => 'style', 'url' => plugins_url('/inc/bulma/css/bulma_compiled.css', __FILE__ )),
	),
	'admin' => array(
		...
		array( 'type' => 'style', 'url' => plugins_url('/css/ui.css', __FILE__  ) ),
		
		array( 'type' => 'script', 'url' => plugins_url('/js/admin.js', __FILE__ ), 'enq' => array( 'jquery', 'jquery-ui-core', 'jquery-ui-mouse', 'jquery-ui-widget', 'jquery-ui-sortable' ), 'localization' => array( 'add_url' => get_option('home').'/wp-admin/post-new.php?post_type=event' ) ),
		array( 'type' => 'style', 'url' => plugins_url('/css/admin.css', __FILE__ ) ),
	),
	'front' => array(
	 
		array( 'type' => 'script', 'url' => plugins_url('/js/math.min.js', __FILE__ ), 'enq' => array( 'jquery' ) ),
